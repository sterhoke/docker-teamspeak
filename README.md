docker-teamspeak
==================
Based on solidnerd/teamspeak and mbentley/teamspeak
modified by ster

## Current Version: [3.0.13.8]
...
```
docker run -d --name="teamspeak_server"  --env-file=.envfile -p "9987:9987/udp" -p 10011:10011 -p 30033:30033 -p 41144:41144  --link teamspeak-mysql:mysql solidnerd/teamspeak:3.0.13.8
```
